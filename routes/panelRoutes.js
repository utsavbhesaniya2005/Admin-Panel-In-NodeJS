...
// Profile Page Render
route.get('/myProfile', panelController.myProfile);

// Edit Personal Info
route.get('/editInfo/:id', panelController.editInfo);

// Edit Address Info
route.get('/editAddress/:id', panelController.editAddress);
...
route.get('/addBlog', panelController.addBlog);
